...
if __name__ == "__main__":
    ...
    parser.add_argument("times", help="run times", type=int)
    args = parser.parse_args()
    times = args.times
    email = 'fufu@meirishentie.com'
    server_id = 20
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        for i in range(times):
            ...
            # 开战
            s.sendall(b'')
            read_all(s)
            # 结束
            s.sendall(b'')
